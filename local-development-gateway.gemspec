...
require_relative "lib/local_development_gateway/version"

Gem::Specification.new do |spec|
  spec.name = "local-development-gateway"
  spec.version = LocalDevelopmentGateway::VERSION
  spec.summary = "Shared loopback gateway lifecycle for local Docker development"
  spec.description = "Ruby API and CLI for starting, monitoring, and conditionally stopping the shared Docker gateway."
